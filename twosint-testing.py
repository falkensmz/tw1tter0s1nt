...
print("")
print("WARNING!!! - You are using twosint-testing (beta version) which suggests that you will probably run into bugs,")
print("")
print("Currently, the tool does not do anything different from tw1tter0s1nt but it will in the near future")
print()
print("twosint-testing - version 0.1")
print("")
print("")
